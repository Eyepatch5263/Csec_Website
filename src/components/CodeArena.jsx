...
const CodeArena = () => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-[120dvh] w-full">
      {" "}
      {/* Increased height for better scroll feel */}
      ...
      >
        ...
        <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            The{" "}
            <span className="text-white font-medium underline decoration-purple-500/50 underline-offset-4">
              Ultimate
            </span>{" "}
            Competitive Programming Battle for the next generation of engineers.
          </motion.p>
          ...
          >
            ...
            <FeatureLine
              ...
              text="Real-time live scoring system"
            />
            <FeatureLine
              icon={<Trophy size={18} className="text-purple-400" />}
              text="Certificates and recognition"
            />
          </motion.div>
          ...
          >
            <button className="pointer-events-auto group relative px-10 py-4 bg-purple-600 hover:bg-purple-500 text-white font-black rounded-xl transition-all shadow-[0_0_20px_rgba(147,51,234,0.3)] hover:shadow-[0_0_30px_rgba(147,51,234,0.5)]">
              <a
                className="flex items-center justify-center gap-2 uppercase relative z-10"
                target="_blank"
                href="https://unstop.com/p/codearena26-nit-hamirpur-1652669"
              >
                Enter Arena{" "}
                <ChevronRight
                  size={20}
              ...
              <div className="p-8 md:p-12">
                <div className="flex justify-between items-center mb-10">
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs font-mono mt-1 tracking-widest uppercase">
                      Encryption Level: Sigma-9
                    </p>
                  </div>
                  <button
                    onClick={() => setShowRules(false)}
